...
**Tech Stack:** Python ≥3.9, aiogram ≥3.4 <4, pytest + pytest-asyncio, hatchling, ruff, mypy, GitHub Actions.
...
- `requires-python = ">=3.9"`. Target CI matrix: Python 3.9/3.11/3.13 × aiogram 3.4.1/latest.
